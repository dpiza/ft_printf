...
/*   Updated: 2021/08/19 21:44:23 by dpiza            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	// retorno = printf("OG: Tres flags: String: %s Endereço: %p Hex: %x ", vChar02, vChar02, vInt01);
	// printf("Retorno: %d\n", retorno);
	// retorno = ft_printf("FT: Tres flags: String: %s Endereço: %p Hex: %x ", vChar02, vChar02, vInt01);
	// printf("Retorno: %d\n\n", retorno);
